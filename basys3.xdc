...
#set_property PACKAGE_PIN W2 [get_portsobj {sw[12]}]
...
#set_property PACKAGE_PIN E19 [get_portobjs {led[1]}]
...
#set_property PACKAGE_PIN W7 [get_ports {c1}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c1}]

#set_property PACKAGE_PIN W6 [get_ports {c2}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c2}]

#set_property PACKAGE_PIN U8 [get_ports {c3}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c3}]

#set_property PACKAGE_PIN V8 [get_ports {c4}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c4}]

#set_property PACKAGE_PIN U5 [get_ports {c5}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c5}]

#set_property PACKAGE_PIN V5 [get_ports {c6}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c6}]

#set_property PACKAGE_PIN U7 [get_ports {c7}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {c7}]
...
#set_property PACKAGE_PIN U2 [get_ports {b1}]

#        set_property IOSTANDARD LVCMOS33 [get_ports {b1}]

#set_property PACKAGE_PIN U4 [get_ports {b2}]
...
#set_property PACKAGE_PIN W4 [get_ports {b4}]
